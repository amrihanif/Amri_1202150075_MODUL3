...
public class adapterRecyclerView extends RecyclerView.Adapter<adapterRecyclerView.ViewHolder> {
    ...
    adapterRecyclerView(ArrayList<String> arrayListTitle, ArrayList<String> arrayListDesc, ArrayList<Integer> arrayListGambar){
    ...
    public adapterRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View V = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_list_produk, parent,false);
